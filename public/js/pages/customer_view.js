...
$('.nav-stretch').on('click', '.nav-link', function () {
    ...
    if (loadapistatus == '2') {
        initializeCustomerPaymentTable()
    }
    if (loadapistatus == '4') {
        initializeCustomerLoginTable()
    }
    //login_data_table
});
...
function get_customer_current_subscription_data(id) {
    var actionUrl = baseUrl + "/api/customer_current_subscription_data";
    //var method = "GET";
    $.ajax({
        url: actionUrl,
        data: { id: id },
...
function initializeCustomerPaymentTable() {
    ...
    var table = $("#data_table").DataTable({
        ...
        "serverMethod": "post",
        "ajax": {
            "url": baseUrl + "/api/customerpaymentHistory",
            "accept": "application/json",
            "data": function (d) {
                d.customer_id = $("#customer_id").val(); // Add customer ID to the request
                return d;
            },
...
function initializeCustomerLoginTable() {
    if ($.fn.DataTable.isDataTable("#login_data_table")) {
        $("#login_data_table").DataTable().destroy();
    }

    var table = $("#login_data_table").DataTable({
        "searching": true,
        "ordering": false,
        "aLengthMenu": [
            [10, 15, 25, 50, 100, -1],
        ...
        "serverMethod": "post",
        "ajax": {
            "url": baseUrl + "/api/customerLoginHistory",
            "accept": "application/json",
            "data": function (d) {
